...
run40: solver
	@cat wt40.txt | ./solver 40 125 $(POPULATION_SIZE) $(AGE_THRESHOLD) $(ALPHA_THRESHOLD) $(REITER_THRESHOLD)

valgrind40: solver_debug 
	@cat wt40.txt | valgrind ./solver_debug 40 125 $(POPULATION_SIZE) $(AGE_THRESHOLD) $(ALPHA_THRESHOLD) $(REITER_THRESHOLD)
